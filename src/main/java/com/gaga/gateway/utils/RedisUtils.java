package com.gaga.gateway.utils;
...
public class RedisUtils {
   ...
   public static Set<Object> getSetAll(final String key) {
     ...
     */
    public static boolean zsetSet(final String key, final Object value, double score) {
     ...
     * @return 移除的个数
     */
    public static long zsetDel(final String key, final Object values) {
        Long count = redisTemplate.opsForZSet().remove(key, values);
        return count == null ? 0 : count;
    }
     ...
     **/
    public static Object listPop(final String key){
     ...
     * @Return void
     **/
    public static void sendMessageToCannel(final String cannel, final String message){
